...
- (void)loadCircleChart{
    ...
    self.circlePercentView.center       = CGPointMake(Width / 2.f-50, 180*ScreenHeightRate);
    self.circlePercentView.lineWidth    = \
    self.circlePercentView.width/2 > self.circlePercentView.height/2 ?self.circlePercentView.height/2: self.circlePercentView.width/2;
    ...
    self.circleInfomationView.center = CGPointMake(Width / 2.f+120, 180*ScreenHeightRate);
